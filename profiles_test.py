...
ne_CTS = ne_CTS.flatten()
err_ne_CTS = dev_ne_CTS.flatten()
...
t_grid_ETS, channel_grid_ETS = scipy.meshgrid(t_ne_ETS, channels)

ne_ETS = ne_ETS.flatten()
err_ne_ETS = dev_ne_ETS.flatten()
